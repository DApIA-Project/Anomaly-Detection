...
# Import the model
from B_Model.AircraftClassification.Transformer_img import Model

# Import the context (hyperparameters, constants, etc...)
import C_Constants.AircraftClassification.Transformer_img as CTX
import C_Constants.AircraftClassification.DefaultCTX as DefaultCTX

# Import the training loop adapted to the model
from E_Trainer.AircraftClassification.MapTrainer import Trainer
