...
# used model LSM
from B_Model.ClassifyHelico.LSTM import Model
import C_Constants.ClassifyHelico.LSTM as CTX
...
def __main__():
    trainable_hyperparameters = {
            ...
            "NB_LSTM" : Mutation(function=add, rate=1, min=1),
            "NB_UNITS" : Mutation(function=mult, rate=2, min=1),
        }
